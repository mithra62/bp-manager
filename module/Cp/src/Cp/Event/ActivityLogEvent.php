...
class ActivityLogEvent extends BaseEvent
{
    ...
    public function logBookmarkAdd(\Zend\EventManager\Event $event)
    {
        ...
        $data = array(
            ...
            'company_id' => $bookmark_data['company_id'],
            'task_id' => $bookmark_data['task_id'],
            'type' => 'bookmark_add',
            'performed_by' => $this->identity
        );
        $this->al->logActivity($data);
    ...
    public function logFileRevisionAdd(\Zend\EventManager\Event $event)
    {
        ...
        if ($total_revisions > 1) {
            $data = array(
                'stuff' => $data,
                'file_rev_id' => $revision_id,
                'file_id' => $data['file_data']['id'],
                'project_id' => $data['file_data']['project_id'],
                'company_id' => $data['file_data']['company_id'],
                'task_id' => $data['file_data']['task_id'],
                'type' => 'file_revision_add',
                'performed_by' => $this->identity
            );
            $this->al->logActivity($data);
        }
    ...
    public function logFileRevisionRemove(\Zend\EventManager\Event $event)
    {
        ...
        $data = array(
            'stuff' => $data,
            'file_rev_id' => $revision_id,
            'file_id' => $revision_data['file_id'],
            'project_id' => $file_data['project_id'],
            'company_id' => $file_data['company_id'],
            'task_id' => $file_data['task_id'],
            'type' => 'file_revision_remove',
            'performed_by' => $this->identity
        );
        $this->al->logActivity($data);
    }
